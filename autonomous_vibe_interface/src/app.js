...
<head>
    ...
    <title>Coder1 - AI-Powered Development Platform</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>🚀 Coder1 Platform</h1>
        <p>AI-powered development environment with native Claude Code integration</p>
...
app.get('/ide', (req, res) => {
    res.sendFile(path.join(__dirname, 'static', 'ide-react.html'));
});
