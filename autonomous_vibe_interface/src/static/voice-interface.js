class VoiceInterface {
    ...
    async processTextCommand(text) {
        ...
        if (lowerText.includes('open ide') || lowerText.includes('launch ide')) {
            return { success: true, action: 'navigate', target: '/ide', message: 'Opening IDE...' };
        }
        ...
        if (lowerText.includes('start building') || lowerText.includes('create project')) {
            return { success: true, action: 'requirements', message: 'Starting project builder...' };
        }
        ...
        if (lowerText.includes('help') || lowerText.includes('what can you do')) {
            return { 
                success: true, 
                action: 'help', 
                message: `I can help you with voice commands like:
                - "Open IDE" to launch the code editor
                - "Go home" to return to the main page
                - "Start building" to create a new project
        ...
        return { 
            success: true, 
            action: 'chat', 
            message: `I heard you say: "${text}". Try commands like "open IDE" or "go home".` 
        };
    }
