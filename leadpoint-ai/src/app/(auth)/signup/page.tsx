  ...
  return (
    <div>
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-slate-400 mt-1">Start automating your social media growth</p>
      </div>
      ...
      <form action={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-start">
          <input
            ...
            className="mt-1 h-4 w-4 rounded border-slate-700 bg-slate-800 text-purple-500 focus:ring-purple-500/50 focus:ring-offset-0"
          />
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <button
          type="button"
          disabled
          className="flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-800/50 border border-slate-700/50 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white hover:border-slate-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          title="Coming soon"
        >
