        ...
        <div className="h-full flex flex-col bg-bg-secondary text-text-primary overflow-hidden border border-coder1-cyan/50 shadow-glow-cyan">
            ...
            <div className="flex-shrink-0 p-4 border-b border-border-default">
                ...
                <div className="flex items-center justify-between mt-3">
                    ...
                    <div className="flex rounded overflow-hidden border border-border-default text-sm">
                        <button
                            className={`px-3 py-1 transition-colors ${activeTab === 'search' ? 'bg-coder1-cyan text-black font-medium' : 'bg-bg-tertiary text-text-muted hover:text-text-primary'}`}
                            onClick={() => setActiveTab('search')}
                        >
                            Search
                        </button>
                        <button
                            className={`px-3 py-1 transition-colors ${activeTab === 'graph' ? 'bg-coder1-cyan text-black font-medium' : 'bg-bg-tertiary text-text-muted hover:text-text-primary'}`}
            ...
            {/* Content Area */}
            {activeTab === 'search' && <div className="flex-1 overflow-y-auto p-4">
                {/* Error Message */}
                {error && (
