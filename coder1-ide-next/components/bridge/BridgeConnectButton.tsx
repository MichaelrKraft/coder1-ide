                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div
                              ...
                              onClick={() => copyToClipboard('curl -sL https://coder1.ai/install-bridge.sh | bash', 'install')}
                            >
                              <div
                              ...
                              >
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-white">curl -sL https://coder1.ai/install-bridge.sh | bash</span>
                                  </div>
