...
function MiniNavbar() {
  ...
  return (
    <header className={`relative z-20
                       ...
                       pl-6 pr-6 py-4 backdrop-blur-sm
                       ${headerShapeClass}
                       border border-[#333] bg-[#1f1f1f57]
                       w-[calc(100%-2rem)] sm:w-auto mx-auto mb-12
        ...
        <div className="flex flex-1 flex-col lg:flex-row ">
          ...
          <div className="flex-1 flex flex-col justify-center items-center">
            <div className="w-full max-w-sm">
              {/* Navigation placed here, directly above content */}
              <MiniNavbar />
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome to Coder1</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Please sign in to get started</p>
                    </div>
