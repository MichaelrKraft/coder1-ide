function generateFrontendPrompt(requirements, agent) {
...
function determineStyleApproach(techStack) {
...
function determineStateManagement(requirements) {
...
module.exports = { generateFrontendPrompt };
