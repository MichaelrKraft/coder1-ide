function generateTestingPrompt(requirements, agent) {
...
function determineTestingFrameworks(requirements) {
  const frontend = requirements.techStack.frontend;
  
  if (frontend && frontend.includes('React')) {
...
- **Mocking**: vi.mock() or jest.mock()`;
  ...
  if (frontend && frontend.includes('Vue')) {
...
module.exports = { generateTestingPrompt };
