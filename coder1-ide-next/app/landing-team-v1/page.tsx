...
import {
  ...
  AlertTriangle, BarChart3, ExternalLink, Users
} from 'lucide-react';
  ...
  const sections = [
    {
      ...
      title: 'Team created 5 PRs overnight',
      items: [
        '- @sarah: Added dark mode toggle (127 lines)',
        '- @mike: Optimized API caching (89 lines)',
        '- @johnny5: Fixed mobile responsive issues (56 lines)'
      ]
    },
    {
      icon: BarChart3,
      color: 'text-coder1-cyan',
      title: 'Shared context updated',
      items: [
        '- New API patterns documented by @alex',
        '- Component library expanded with 3 new components'
      ]
    },
    {
      icon: TrendingUp,
      color: 'text-amber-400',
      title: 'Johnny5 spotted 3 opportunities',
      items: [
    ...
    },
    {
      icon: AlertTriangle,
      color: 'text-red-400',
      title: '2 items need team attention',
      items: [
        '- PR #124 has merge conflict with PR #127',
    ...
    <div className="relative">
      <div className="bg-[#0D0D0D] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center gap-2 px-4 py-3 bg-[#1A1A1A] border-b border-white/5">
          ...
          <span className="text-xs text-white/40 ml-2 font-mono">johnny5 - team morning brief</span>
        </div>

        {/* Content */}
        <div className="p-6 font-mono text-sm space-y-4">
          <div className="text-coder1-cyan animate-pulse">
            Good morning team! Here&apos;s what happened overnight:
          </div>
...
function LiveTerminalDemo() {
  ...
  const lines = [
    { type: 'command', text: '$ johnny5 start --mode=team-overnight' },
    { type: 'output', text: 'Johnny5 initializing for team...' },
    { type: 'output', text: 'Connecting to shared team context...' },
    { type: 'success', text: 'Connected to team: acme-saas (5 members)' },
    { type: 'output', text: 'Syncing work across @sarah, @mike, @alex...' },
    { type: 'output', text: 'Found 3 parallel tasks with no conflicts' },
    { type: 'command', text: '> @johnny5: Building "Add dark mode toggle"' },
    { type: 'output', text: 'Checking team context for existing patterns...' },
    { type: 'output', text: 'Found: @alex\'s theme system - reusing...' },
    { type: 'output', text: 'Writing tests with team conventions...' },
    { type: 'success', text: 'PR #47 created - notifying team channel' },
    { type: 'output', text: '' },
    { type: 'command', text: '> Coordinating with @sarah\'s work...' },
    { type: 'output', text: 'Detected potential merge conflict...' },
    { type: 'success', text: 'Resolved: rebased on @sarah\'s branch' },
    { type: 'alert', text: 'Team brief scheduled for 8:00 AM' },
  ];
  ...
  return (
    <div className="bg-[#0D0D0D] rounded-xl border border-white/10 overflow-hidden font-mono text-xs">
      <div className="flex items-center gap-2 px-4 py-2 bg-[#1A1A1A] border-b border-white/5">
        ...
        <span className="text-[10px] text-white/30 ml-2">johnny5 --team-mode</span>
      </div>
...
// MAIN PAGE COMPONENT
// ============================================================================
export default function LandingTeamV1Page() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/alpha/waitlist', {
        ...
        body: JSON.stringify({ email, github, source: 'landing_team_v1' })
      });
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-12">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            <Users className="w-4 h-4 text-coder1-purple" />
          ...
          {/* Subtitle - Teams messaging */}
          <div className="mb-6 subtitle-fade-in">
            <p className="text-4xl md:text-5xl lg:text-6xl text-white font-bold">
              The First IDE Built for
            </p>
            <p className="text-4xl md:text-5xl lg:text-6xl text-coder1-cyan font-bold">
              AI-Powered Teams
            </p>
          </div>

          {/* Subhead */}
          <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-4 leading-relaxed font-medium">
            Real-time collaboration. Shared AI memory. Local code security.
          </p>

          {/* Description */}
          <p className="text-lg text-white/50 max-w-3xl mx-auto mb-10 leading-relaxed">
            AI tools make individuals 10x productive. But teams still coordinate like it&apos;s 2010. Coder1 is the first IDE where your whole team works with AI together.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-white/40 text-sm">Faster Shipping</p>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-coder1-purple mb-1">
                24/7
              </div>
              <p className="text-white/40 text-sm">Team AI Coverage</p>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-orange-400 mb-1">
                100%
              </div>
              <p className="text-white/40 text-sm">Shared Context</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16">
            {[
              { audience: 'Startup Teams', message: 'Ship features 3x faster with coordinated AI' },
              { audience: 'Development Teams', message: 'Real-time collaboration + autonomous AI in one IDE' },
              { audience: 'Agencies', message: 'Manage multiple client projects with shared context' }
            ].map((hook, idx) => (
      ...
      {/* ===== WHY TEAMS CHOOSE CODER1 SECTION ===== */}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-coder1-cyan/10 border border-coder1-cyan/20 rounded-full mb-6">
                ...
                <span className="text-coder1-cyan text-base font-medium">Team-First Design</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">
                Why Teams Choose Coder1
              </h2>
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Built from the ground up for collaborative AI development
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: Brain,
                title: "Team-Wide Context",
                desc: "AI learns your codebase once. Everyone benefits. No more re-explaining the same patterns."
              },
              {
                icon: Eye,
                title: "Real-Time Collaboration",
                desc: "Google Docs-style editing on local files. See what your teammates are working on in real-time."
              },
              {
                icon: Bot,
                title: "Coordinated Autonomy",
                desc: "Multiple AIs that know what each other is working on. No conflicts, no duplicate work."
              },
              {
                icon: Zap,
                title: "10x Productivity",
                desc: "When AI handles the grunt work overnight, your team focuses on what matters—shipping features that move the needle."
              },
              {
                icon: History,
                title: "Time Capsules",
                desc: "Every AI session permanently linked to its commit. Review exactly what AI conversation led to any code change—even months later."
              }
            ].map((item, idx) => (
              <ScrollReveal key={idx} delay={idx * 100}>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Everything your team needs to build, all in one place
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-coder1-purple/10 border border-coder1-purple/20 rounded-full mb-6">
                ...
                <span className="text-coder1-cyan text-base font-medium">Your Team&apos;s AI Employee</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                Meet <span className="text-shimmer">Johnny5</span>
              </h2>
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                The autonomous agent that works while your team sleeps
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {[
              {
                icon: Moon,
                title: 'Works While Your Team Sleeps',
                desc: 'Johnny5 builds features overnight. Your team wakes up to completed work, ready for review. No more late nights.'
              },
              {
                icon: Sun,
                title: 'Team-Wide Morning Briefings',
                desc: 'Everyone starts the day knowing what got done. Clear summaries for the whole team, not just individuals.'
              },
              {
                icon: Brain,
                title: 'Shared Persistent Memory',
                desc: 'AI context that survives developer turnover. New team members get up to speed instantly.'
              },
              {
                icon: GitPullRequest,
                title: 'Coordinated PR Creation',
                desc: 'Creates PRs that account for everyone\'s work. No merge conflicts, no duplicate implementations.'
              },
              {
                icon: MessageCircle,
                title: 'WhatsApp Communication',
                desc: 'Message Johnny5 directly via WhatsApp. Get updates, ask questions, and give instructions from anywhere.'
              },
              {
                icon: Infinity,
                title: '8,000+ MCP Integrations',
                desc: 'Connect to thousands of tools and services. Johnny5 works with your entire team\'s stack.'
              }
            ].map((card, idx) => (
              <ScrollReveal key={idx} delay={idx * 100}>
          ...
          <ScrollReveal>
            <div className="p-8 bg-gradient-to-br from-coder1-cyan/10 to-coder1-purple/10 border border-coder1-cyan/20 rounded-2xl transition-all duration-300 hover:border-orange-400/60 hover:shadow-lg hover:shadow-orange-400/40">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Team Security Transparency</h3>
                  <p className="text-white/50 text-lg leading-relaxed">
                    See every decision, every action, full audit trail across your entire team.
                    Know exactly what Johnny5 did and why. Full session replay available for all team members.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                Your Team Wakes Up to This
              </h2>
              <p className="text-lg text-white/50">
                Your daily team briefing from Johnny5 - click to reveal each section
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-3 px-6 py-3 bg-coder1-cyan/10 border border-coder1-cyan/20 rounded-full mb-6">
                ...
                <span className="text-coder1-cyan text-lg font-medium">Real Team Results</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                What Johnny5 Built for Teams Last Night
              </h2>
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Actual PRs created by Johnny5 for alpha teams while they slept
              </p>
            </div>
          </ScrollReveal>
            ...
            {[
              ...
              <ScrollReveal key={idx} delay={idx * 100}>
                <div className="p-6 bg-[#0D0D0D] border border-white/10 rounded-xl hover:border-coder1-cyan/30 transition-all">
                  ...
                  <p className="text-coder1-purple text-xs mb-2">{item.team}</p>
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                See Everything Your Team&apos;s AI Does
              </h2>
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Other AI tools are black boxes. Johnny5 shows your whole team everything.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { icon: ClipboardList, title: 'Full Team Audit Trail', desc: 'Every action logged with timestamp and reasoning' },
              { icon: ShieldAlert, title: 'Prompt Injection Detection', desc: 'Real-time blocking of suspicious inputs' },
              { icon: Lock, title: 'Permission Boundaries', desc: 'Clear scope definitions per team member' },
              { icon: PlayCircle, title: 'Session Replay', desc: 'Step-by-step playback for the whole team' }
            ].map((item, idx) => (
              <ScrollReveal key={idx} delay={idx * 100}>
                <div
        ...
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                A complete team development experience
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-4 gap-5">
            {[
              { icon: Brain, name: 'Shared Memory', desc: 'Team-wide context that persists' },
              { icon: Mic, name: 'Voice-to-Text', desc: 'Code at the speed of thought' },
              { icon: Eye, name: 'AI Supervision', desc: 'AI watches all team sessions' },
              { icon: Zap, name: 'Templates & Hooks', desc: 'Team-wide automation' },
              { icon: Book, name: 'Team Wiki', desc: 'Living documentation for all' },
              { icon: FileText, name: 'Session Summaries', desc: 'Seamless team handoffs' },
              { icon: Palette, name: 'Component Studio', desc: 'Shared visual components' },
              { icon: Slash, name: '/Commands', desc: 'Team-wide slash commands' }
            ].map((feature, idx) => (
              <ScrollReveal key={idx} delay={idx * 50}>
                <div
        ...
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                The only open source IDE with real-time team collaboration. And it&apos;s cheaper than Cursor.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="overflow-x-auto">
              <table className="w-full bg-white/[0.02] rounded-xl border border-white/5 overflow-hidden">
                ...
                <tbody>
                  <ComparisonRow feature="Real-time Team Collaboration" coder1="yes" cursor="no" copilot="no" vscode="no" tooltip="Google Docs-style editing with teammates" />
                  <ComparisonRow feature="Shared Team Memory" coder1="yes" cursor="no" copilot="no" vscode="no" tooltip="AI context shared across all team members" />
                  <ComparisonRow feature="Full IDE" coder1="yes" cursor="yes" copilot="no" vscode="yes" />
                  <ComparisonRow feature="Autonomous Overnight Work" coder1="yes" cursor="no" copilot="no" vscode="no" tooltip="Johnny5 works while your team sleeps" />
                  <ComparisonRow feature="Team Morning Briefings" coder1="yes" cursor="no" copilot="no" vscode="no" />
                  <ComparisonRow feature="Coordinated PR Creation" coder1="yes" cursor="no" copilot="no" vscode="no" />
                  <ComparisonRow feature="Team Security Audit Trail" coder1="yes" cursor="no" copilot="no" vscode="no" />
                  ...
                  <ComparisonRow feature="Open Source Core" coder1="yes" cursor="no" copilot="no" vscode="partial" tooltip="Full IDE is open source under Apache 2.0" />
          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/30 rounded-full mb-6">
                ...
                <span className="text-emerald-400 text-sm font-semibold">Open Source Core</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                Open Source Core. Enterprise-Ready Teams.
              </h2>
              <p className="text-lg text-white/50">
                Coder1 is free and open source for individual developers. Upgrade to Pro for unlimited AI power, or Team for real-time collaboration.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <ScrollReveal delay={0}>
              <PricingCard
                ...
                period="forever"
                features={[
                  'Full IDE (Monaco, terminal, Git)',
                  '50 Johnny5 messages/month',
                  'All 8,000+ MCP integrations',
                  'Individual persistent memory',
                  'Session management',
                  'Security & audit logs',
                  'Community support'
                ]}
                cta="Get Started"
                badge="Open Source"
                subtext="View the code on GitHub"
        ...
        <div className="max-w-3xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-coder1-cyan">
                Everything your team needs to know about Coder1 IDE
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="space-y-3">
            <ScrollReveal delay={50}>
              <FAQItem
                question="Is Coder1 really open source?"
                answer="Yes! The core IDE (editor, terminal, file management, Git integration, Johnny5 basic, MCP integrations) is fully open source. You can view, modify, and contribute to the code on GitHub. Our paid plans (Pro, Team) include proprietary features like unlimited Johnny5 messages, team collaboration, and shared team memory—these require server infrastructure that has real costs."
              />
            </ScrollReveal>

            <ScrollReveal delay={75}>
              <FAQItem
                question="What makes Coder1 different from Cursor or GitHub Copilot for teams?"
                answer="Coder1 is the only IDE built specifically for AI-powered teams. Unlike Cursor or Copilot which focus on individual productivity, Coder1 provides real-time collaboration, shared AI memory across your team, and Johnny5 - an autonomous agent that works overnight and briefs your entire team every morning. Plus, you get full team audit trails and session replay."
              />
            </ScrollReveal>

            <ScrollReveal delay={100}>
              <FAQItem
                question="How does shared team memory work?"
                answer="When any team member teaches the AI something - architecture decisions, coding patterns, project context - that knowledge becomes available to everyone on the team. New team members get up to speed instantly, and context survives developer turnover. The AI learns your codebase once, and everyone benefits."
              />
            </ScrollReveal>

            <ScrollReveal delay={150}>
              <FAQItem
                question="Can Johnny5 coordinate work across multiple team members?"
                answer="Yes! Johnny5 is aware of what each team member is working on. It avoids conflicts, reuses existing patterns that teammates have created, and creates PRs that account for everyone's work. No more merge conflicts from duplicate implementations."
              />
            </ScrollReveal>
            ...
            <ScrollReveal delay={200}>
              <FAQItem
                ...
                answer="Think Google Docs, but for code. Multiple team members can work on the same files simultaneously, see each other's cursors, and watch changes in real-time. All while keeping code on your local machines - we don't store your code on our servers."
              />
            </ScrollReveal>

            <ScrollReveal delay={250}>
              <FAQItem
                question="Is our team's code secure?"
                answer="Your code never leaves your team's machines unless you explicitly push to GitHub. The bridge CLI runs locally on each team member's machine. We don't store your code on our servers. All team members can see a full audit trail of every AI action, and you can replay any session."
              />
            </ScrollReveal>

            <ScrollReveal delay={300}>
              <FAQItem
                question="How do team morning briefings work?"
                answer="Every morning, your entire team gets a summary of what Johnny5 accomplished overnight - PRs created, research completed, and items needing attention. Everyone starts the day on the same page, knowing exactly what got done and what needs review."
              />
            </ScrollReveal>
            ...
            <ScrollReveal delay={350}>
              <FAQItem
                ...
                answer="The Team plan includes everything in Pro plus: real-time collaboration, shared team memory, team coordination dashboard, autonomous team coordination, and priority team support. It's $35 per user per month, designed specifically for teams building together."
              />
            </ScrollReveal>

            <ScrollReveal delay={400}>
              <FAQItem
                question="How do we get started with our team?"
                answer="Sign up below with your email. We're onboarding teams in batches to ensure quality support. Once accepted, you'll get access to the full IDE, team setup guides, and our Discord community where the team is actively helping users and gathering feedback."
              />
            </ScrollReveal>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-xl mx-auto px-6 text-center pt-40">
          <ScrollReveal>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/5 border border-amber-500/20 rounded-full mb-6">
              ...
              <span className="text-amber-300/80 text-sm font-semibold">Limited team spots remaining</span>
            </div>

            <h2 className="font-bold mb-4 tracking-tight text-center">
              <span className="block text-3xl sm:text-4xl md:text-5xl">Ready to Build as a Team?</span>
              <span className="block text-2xl sm:text-3xl md:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-coder1-cyan to-coder1-purple">
                Join Teams Shipping Faster with Shared AI
              </span>
            </h2>
            <p className="text-lg text-white/50 mb-10">
              Team access is limited. Get in for free and ship 3x faster together.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mb-8">
              ...
              >
                {isSubmitting ? 'Joining...' : 'Request Team Access'}
              </button>
            </form>
