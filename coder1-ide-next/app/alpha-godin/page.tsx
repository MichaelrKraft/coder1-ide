        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <h1 className="mb-6 subtitle-fade-in">
            <span style={{display:'block'}} className="text-4xl md:text-5xl lg:text-6xl text-white/80 font-semibold">
              <span className="text-coder1-cyan">Never Lose Progress</span>
            </span>
            <span style={{display:'block'}} className="text-4xl md:text-5xl lg:text-6xl text-white/80 font-semibold">
              When Your Terminal <span className="text-coder1-cyan">Crashes Again</span>
            </span>
          </h1>

          {/* Description */}
          <p className="text-lg text-white/50 max-w-2xl mx-auto mb-3 leading-relaxed">
            You already pay for Claude Code. Coder1 gives you the IDE experience—with session recovery,
            overnight autonomy, and zero additional cost.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-white/40 text-sm">Extra Cost</p>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-coder1-purple mb-1">
                0 Lost
              </div>
              <p className="text-white/40 text-sm">Sessions This Month</p>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-orange-400 mb-1">
                30s
              </div>
              <p className="text-white/40 text-sm">From Install to Code</p>
            </div>
          </div>

          {/* Audience line - clearer positioning */}
          <p className="text-base text-white/50 text-center mt-12">
            For developers who already use{' '}
            <span className="text-coder1-cyan font-medium">Claude Code CLI</span>
            {' '}and don't want to pay twice for AI
          </p>
        </div>
