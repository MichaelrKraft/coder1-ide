...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('❌ [Unified] Sessions GET error:', error);
    return NextResponse.json(
      {
        success: false,
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`✅ [Unified] Session created: ${sessionId} (${type})`);
    ...
    console.error('❌ [Unified] Sessions POST error:', error);
    return NextResponse.json(
      {
        success: false,
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (activeSessions.has(sessionId)) {
      ...
      console.log(`✅ [Unified] Session deleted: ${sessionId}`);
    ...
    console.error('❌ [Unified] Sessions DELETE error:', error);
    return NextResponse.json(
      {
        success: false,
