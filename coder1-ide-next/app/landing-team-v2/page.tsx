...
import {
  ...
  AlertTriangle, BarChart3, ExternalLink, Users, Building2, Landmark
} from 'lucide-react';
...
function ComparisonRow({
  ...
  const renderCell = (value: string, isCoder1 = false) => {
    ...
    if (value === 'partial') return <span className="text-amber-400 text-xs">Partial</span>;
  ...
  return (
    ...
    >
      ...
      <td className="py-4 px-4 text-center">{renderCell(replit)}</td>
      <td className="py-4 px-4 text-center">{renderCell(cloudIDEs)}</td>
    </tr>
  );
}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/alpha/waitlist', {
        ...
        body: JSON.stringify({ email, github, source: 'landing_team_v2' })
      });
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-12">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          {/* Subtitle - The Third Way messaging */}
          ...
          <p className="text-xl text-white/60 max-w-3xl mx-auto mb-6 leading-relaxed">
            The only IDE where your team collaborates in real-time while code stays on local machines.
          </p>
          <p className="text-lg text-white/50 max-w-3xl mx-auto mb-10 leading-relaxed">
            Cloud IDEs put your code on their servers. Editor extensions isolate your developers. Coder1&apos;s bridge architecture gives you both: real-time team collaboration AND local code security.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-white/40 text-sm">Code on Our Servers</p>
            </div>
            <div className="text-center">
          ...
          {/* Audience hooks - Security focused */}
          <div className="grid md:grid-cols-3 gap-6 mt-16">
            {[
              { icon: Building2, audience: 'Enterprise Teams', message: 'SOC 2 ready with full audit trails' },
              { icon: Shield, audience: 'Security-Conscious Teams', message: 'Code never leaves your machine' },
              { icon: Landmark, audience: 'Regulated Industries', message: 'HIPAA, GDPR compliance built-in' }
            ].map((hook, idx) => (
              <ScrollReveal key={idx} delay={idx * 100}>
                <div className="p-6 bg-[#151515] border border-white/10 rounded-xl hover:border-white/20 transition-all">
                  <hook.icon className="w-6 h-6 text-coder1-cyan mb-3" />
        ...
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-coder1-cyan/10 border border-coder1-cyan/20 rounded-full mb-6">
                ...
                <span className="text-coder1-cyan text-base font-medium">Bridge Architecture</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">
                The Bridge Architecture<br />Advantage
              </h2>
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Finally: collaboration WITHOUT sacrificing security
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: Lock,
                title: "Code Stays Local",
                desc: "Your source code never touches our servers. Ever."
              },
              {
                icon: Users,
                title: "Team Sync",
                desc: "Operational transforms sync changes - not code files."
              },
              {
                icon: ClipboardList,
                title: "Audit Everything",
                desc: "Full trail of every AI action, every change, every decision."
              },
              {
                icon: ShieldCheck,
                title: "Zero Trust Compatible",
                desc: "Works within your existing security perimeter."
              },
              {
                icon: History,
                title: "Time Capsules",
                desc: "Every AI session permanently linked to its commit. Complete audit trail for compliance and security reviews."
              }
            ].map((item, idx) => (
              <ScrollReveal key={idx} delay={idx * 100}>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-coder1-purple/10 border border-coder1-purple/20 rounded-full mb-6">
                ...
                <span className="text-coder1-cyan text-base font-medium">Enterprise AI Governance</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                Meet <span className="text-shimmer">Johnny5</span> - Secure Autonomous AI for Teams
              </h2>
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                The only autonomous agent with enterprise-grade governance
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {[
              {
                icon: Moon,
                title: 'Secure Autonomous Work',
                desc: 'Works overnight with full audit trails. Every action logged, every decision documented, every change traceable.'
              },
              {
                icon: Lock,
                title: 'Permission Boundaries',
                desc: 'Granular controls over what AI can access. Define scope, restrict actions, set approval workflows for sensitive operations.'
              },
              {
                icon: ShieldAlert,
                title: 'Prompt Injection Detection',
                desc: 'Real-time blocking of suspicious inputs. ML-based detection of injection attempts with automatic alerting.'
              },
              {
                icon: PlayCircle,
                title: 'Session Replay',
                desc: 'Step-by-step playback for security review. See exactly what the AI did, when, and why - perfect for audits.'
              },
              {
                icon: GitPullRequest,
                title: 'Proactive PR Creation',
                desc: 'Notices feature requests and builds them automatically. Creates PRs for your review - never pushes directly to main.'
              },
              {
                icon: Sun,
                title: 'Morning Briefings',
                desc: 'Start each day knowing exactly what got done. Clear summaries of completed work and items needing attention.'
              }
            ].map((card, idx) => (
              <ScrollReveal key={idx} delay={idx * 100}>
          ...
          <ScrollReveal>
            <div className="p-8 bg-gradient-to-br from-coder1-cyan/10 to-coder1-purple/10 border border-coder1-cyan/20 rounded-2xl transition-all duration-300 hover:border-orange-400/60 hover:shadow-lg hover:shadow-orange-400/40">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Enterprise Security Built-In</h3>
                  <p className="text-white/50 text-lg leading-relaxed">
                    SOC 2 ready. Full audit trails. SSO/SAML support. Zero-trust compatible.
                    Unlike black-box AI tools, Johnny5 shows you exactly what it&apos;s doing and why.
      ...
      {/* ===== COMPARISON SECTION - SECURITY FOCUSED ===== */}
      <section className="py-24 bg-[#080808]">
        <div className="max-w-6xl mx-auto px-6">
          <ScrollReveal>
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
                Only Coder1 Has Both
              </h2>
              <p className="text-lg text-white/50 max-w-2xl mx-auto">
                Compare security and collaboration features
              </p>
            </div>
          </ScrollReveal>
              ...
              <table className="w-full bg-white/[0.02] rounded-xl border border-white/5 overflow-hidden">
                <thead>
                  <tr className="bg-white/[0.05]">
                    ...
                    <th className="py-4 px-4 text-center font-semibold text-white/60">Replit</th>
                    <th className="py-4 px-4 text-center font-semibold text-white/60">Cloud IDEs</th>
                  </tr>
                </thead>
                <tbody>
                  <ComparisonRow feature="Code Stays Local" coder1="yes" cursor="yes" replit="no" cloudIDEs="no" tooltip="Your source code never touches external servers" />
                  <ComparisonRow feature="Team Collaboration" coder1="yes" cursor="no" replit="yes" cloudIDEs="yes" tooltip="Real-time collaborative editing with your team" />
                  <ComparisonRow feature="Enterprise Audit Trails" coder1="yes" cursor="no" replit="partial" cloudIDEs="partial" tooltip="Full logging of every AI action for compliance" />
                  <ComparisonRow feature="Autonomous Overnight Work" coder1="yes" cursor="no" replit="no" cloudIDEs="no" tooltip="Johnny5 works while you sleep, creating PRs and researching" />
                  <ComparisonRow feature="Prompt Injection Detection" coder1="yes" cursor="no" replit="no" cloudIDEs="no" />
                  <ComparisonRow feature="Session Replay" coder1="yes" cursor="no" replit="no" cloudIDEs="no" />
                  <ComparisonRow feature="SSO/SAML Support" coder1="yes" cursor="no" replit="partial" cloudIDEs="yes" />
                  <ComparisonRow feature="Zero Trust Compatible" coder1="yes" cursor="yes" replit="no" cloudIDEs="no" />
                  <ComparisonRow feature="Free Forever Plan" coder1="yes" cursor="no" replit="partial" cloudIDEs="partial" />
                </tbody>
              </table>
            </div>
          </ScrollReveal>
          ...
          {/* Emphasis callout */}
          <ScrollReveal>
            <div className="mt-8 p-6 bg-gradient-to-r from-coder1-cyan/10 to-coder1-purple/10 border border-coder1-cyan/20 rounded-xl text-center">
              <p className="text-xl font-semibold text-white">
                <span className="text-coder1-cyan">Only Coder1</span> delivers both local code security AND real-time team collaboration.
              </p>
              <p className="text-white/50 mt-2">Stop choosing between security and productivity.</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={200}>
              <PricingCard
                ...
                cta="Contact Sales"
                onClick={() => window.location.href = 'mailto:enterprise@coder1.ai?subject=Coder1 Enterprise Inquiry'}
              />
            </ScrollReveal>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-3">
            <ScrollReveal delay={50}>
              <FAQItem
                question="How does code stay local while still enabling collaboration?"
                answer="Coder1 uses a bridge architecture. Your code stays on your local machine - we only sync operational transforms (change metadata) between team members, not the actual source files. Think of it like Google Docs, but the document never leaves your computer."
              />
            </ScrollReveal>

            <ScrollReveal delay={100}>
              <FAQItem
                question="Is Coder1 SOC 2 compliant?"
                answer="Yes. Coder1 is SOC 2 Type II certified. We maintain full audit trails, offer SSO/SAML, support zero-trust architectures, and provide enterprise controls for compliance-conscious organizations."
              />
            </ScrollReveal>

            <ScrollReveal delay={150}>
              <FAQItem
                question="What is Johnny5?"
                answer="Johnny5 is your AI employee built into Coder1. It works autonomously while you sleep - monitoring GitHub issues, Slack conversations, and trend feeds to identify work. It then builds features, creates pull requests, and prepares a morning briefing. Unlike black-box AI tools, every action is logged with full audit trails."
              />
            </ScrollReveal>

            <ScrollReveal delay={200}>
              <FAQItem
                question="Can Johnny5 be restricted to certain actions?"
                answer="Absolutely. Johnny5 has granular permission boundaries. You define what it can access, which repos it can modify, and which actions require human approval. All operations are logged for security review, and you can enable prompt injection detection for additional protection."
              />
            </ScrollReveal>
            ...
            <ScrollReveal delay={250}>
              <FAQItem
                ...
                answer="Johnny5 never pushes directly to your main branch. All work is done in feature branches with pull requests for your review. You have full session replay to see exactly what it did and why. Plus, our prompt injection detection and permission boundaries prevent destructive actions."
              />
            </ScrollReveal>
            ...
            <ScrollReveal delay={300}>
              <FAQItem
                ...
                answer="Yes. Our architecture is designed for regulated industries. Code stays local, audit trails are comprehensive, and we offer enterprise features like SSO, data residency options, and BAA agreements for HIPAA customers."
              />
            </ScrollReveal>
        ...
        <div className="relative z-10 max-w-xl mx-auto px-6 text-center pt-40">
          <ScrollReveal>
            ...
            <h2 className="font-bold mb-4 tracking-tight text-center">
              <span className="block text-3xl sm:text-4xl md:text-5xl">Ready for Secure</span>
            ...
            <p className="text-lg text-white/50 mb-10">
              Join teams who refuse to choose between collaboration and security.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              ...
              <div className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full">
                ...
                <span className="text-white/80 text-sm font-medium">SOC 2 certified</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full">
                <Lock className="w-4 h-4 text-coder1-cyan" />
                <span className="text-white/80 text-sm font-medium">Code stays local</span>
              </div>
            </div>
          </ScrollReveal>
        </div>
