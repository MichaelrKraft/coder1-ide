      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 pb-12">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-white/50 max-w-2xl mx-auto mb-3 leading-relaxed">
            Stop babysitting your Claude Code sessions. Agent Orchestration works autonomously overnight,
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-3">
              <FAQItem
                ...
                answer="Coder1 is purpose-built for Claude Code users. Unlike Cursor or Copilot which focus on code completion, Coder1 provides a complete IDE experience with Agent Orchestration - an autonomous agent that works overnight, creates PRs, and briefs you every morning. Plus, you get full audit trails, session replay, and security transparency that other tools don't offer."
              />
