...
import { ArrowLeft, Palette, Terminal, User, Key, Bell, Shield, Plug } from 'lucide-react';
import IntegrationsPanel from '@/components/settings/IntegrationsPanel';

type SettingsTab = null | 'integrations';
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <button
                ...
                className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-cyan-500 transition-colors cursor-pointer text-left"
              >
                <Plug className="w-8 h-8 text-cyan-400 mb-4" />
                <h3 className="text-xl font-semibold text-white mb-2">Integrations</h3>
                <p className="text-gray-400">Connect deployment platforms</p>
              </button>
            </div>
          </>
        )}
