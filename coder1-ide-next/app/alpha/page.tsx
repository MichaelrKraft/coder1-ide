    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 pb-12">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="text-3xl md:text-4xl lg:text-5xl text-white/80 font-semibold mb-6 whitespace-nowrap subtitle-fade-in">
            The Only <span className="text-coder1-cyan">IDE</span> Built for <span className="text-coder1-cyan">Claude Code</span> Users.
          </p>
