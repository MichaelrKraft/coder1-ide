          ...
          if (command === 'claude' || command.startsWith('claude ')) {
            ...
            // Show help message immediately
              const helpMessage = [
                ...
                '║                                                                     ║\r\n',
                '║  Option 2: Future - Coder1 Companion (Coming Soon)                ║\r\n',
                '║  ────────────────────────────────────────────────                 ║\r\n',
                '║  A local bridge service is in development that will connect       ║\r\n',
                '║  this web IDE to your local Claude Code installation.             ║\r\n',
                '║                                                                     ║\r\n',
                '╚═══════════════════════════════════════════════════════════════════╝\r\n',
                '\r\n'
              ].join('');
