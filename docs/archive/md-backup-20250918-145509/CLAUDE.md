...
**⚠️ BEFORE ATTEMPTING ANY TERMINAL FIXES**: Read [TERMINAL_SCROLLING_SOLUTION_2025-01-21.md](./TERMINAL_SCROLLING_SOLUTION_2025-01-21.md)
...
**Other Terminal Issues**: See the [Terminal Display Fix Guide](./docs/guides/terminal-display-fix.md) for additional troubleshooting.
